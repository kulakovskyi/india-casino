...
const paths = {
  ...
  srcFullJs: ['./src/js/script-home.js', './src/js/script-page2.js', './src/js/script-page3.js', './src/js/script-page4.js', './src/js/script-page5.js', './src/js/script-page6.js', './src/js/script-page7.js', './src/js/script-page8.js', './src/js/script-page9.js', './src/js/script-page10.js', './src/js/script-page11.js', './src/js/script-page12.js'],
